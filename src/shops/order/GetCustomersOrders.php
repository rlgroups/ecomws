    ...
    public function mapDataResponse($data)
    {
        ...
        return [
            ...
            return [
                ...
                'scm_dis' => $linesInOrder[0]['ScmDis'] ?? null,
                'tel_asp' => $linesInOrder[0]['TelAsp'] ?? null,
                'area' => $linesInOrder[0]['Area'] ?? null,
                'card_number' => $linesInOrder[0]['CardNumber'] ?? null,
                'card_type' => $linesInOrder[0]['CardType'] ?? null,
                'city_asp' => $linesInOrder[0]['CityAsp'] ?? null,
                'date_doc' => $linesInOrder[0]['DateAsp'] ?? null,
                'doc_time' => $linesInOrder[0]['DocTime'] ?? null,
                'doc_type' => $linesInOrder[0]['DocType'] ?? null,
                'mikod' => $linesInOrder[0]['Mikod'] ?? null,
                'store_name' => $linesInOrder[0]['StoreName'] ?? null,
